...
| `heating_controls_display_mode` | `subgroup` | `subgroup` renders full-width relay/control tiles; `button` shows a compact oval direct Heating-switch toggle in the Floor-heating heading. |
