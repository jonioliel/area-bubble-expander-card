...
class AreaBubbleExpanderCard extends HTMLElement {
  ...
  styles() {
    ...
    return `<style>
      ...
      @media(max-width:420px){.root{padding:10px}.header{gap:8px;padding-bottom:10px}.title{font-size:17px;line-height:1.3}.area-header{align-items:start;gap:8px;padding:9px}.line{align-items:flex-start;flex-direction:column;gap:2px}.name{overflow:visible;text-overflow:clip;white-space:normal;overflow-wrap:anywhere;line-height:1.28}.count{line-height:1.25}.controls{align-self:start;flex-shrink:0}.icon{width:38px;height:38px}.btn{width:36px;height:36px}.entity{align-items:start;min-height:48px}.chip{max-width:112px}}
    </style>`;
  }
  render() {
